...
add-helm-repos:
	...
	argocd repo add https://releases.rancher.com/server-charts/stable --type helm
--name rancher
	helm repo add grafana https://grafana.github.io/helm-charts --type helm --name grafana
